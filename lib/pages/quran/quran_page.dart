              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing:
                        Text('صفحة ${surah['page']}', style: pageNumberStyle),
                      ...
                      child: ExpansionTile(
                        ...
                        children: surahs.map((surah) {
                          return ListTile(
                            ...
                            onTap: () =>
                                _navigateToPage(context, surah['page']),
                          );
                        }).toList(),
                      ),
                    );
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => QuranCompleteDuaa()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.all(16),
